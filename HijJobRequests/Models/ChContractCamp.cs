...
public partial class ChContractCamp
{
    ...
    public decimal FScopeNo { get; set; }

    public decimal FBoxNo { get; set; }

    public decimal FStreetNo { get; set; }

    public decimal FGateNo { get; set; }

    public decimal FCampNo { get; set; }

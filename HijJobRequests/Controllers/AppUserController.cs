...
namespace HijJobRequests.Controllers
{
    ...
    public class AppUserController : ControllerBase
    {
        ...
        // GET: api/AppUser
        [HttpGet]
        public async Task<ActionResult<PaginationList<AppUser>>> GetAppUsers([FromQuery]PaginationParams paginationParams)
        {
            return await _context.AppUsers.GetPagedAsync(paginationParams);
        }

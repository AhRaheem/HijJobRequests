...
namespace HijJobRequests.Controllers
{
    ...
    public class TdMeasurementController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<PaginationList<TdMeasurement>>> GetTdMeasurements([FromQuery]PaginationParams paginationParams)
        {
            return await _context.TdMeasurements.GetPagedAsync(paginationParams);
        }

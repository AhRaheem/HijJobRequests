...
namespace HijJobRequests.Controllers
{
    ...
    public class TdSupplierController : ControllerBase
    {
        ...
        // GET: api/TdSupplier
        [HttpGet]
        public async Task<ActionResult<PaginationList<TdSupplier>>> GetTdSuppliers([FromQuery]PaginationParams paginationParams)
        {
            return await _context.TdSuppliers.GetPagedAsync(paginationParams);
        }

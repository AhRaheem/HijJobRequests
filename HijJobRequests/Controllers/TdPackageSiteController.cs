...
namespace HijJobRequests.Controllers
{
    ...
    public class TdPackageSiteController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<PaginationList<TdPackageSite>>> GetTdPackageSites([FromQuery]PaginationParams paginationParams)
        {
            return await _context.TdPackageSites.GetPagedAsync(paginationParams);
        }

...
namespace HijJobRequests.Controllers
{
    ...
    public class SysPictController : ControllerBase
    {
        ...
        // GET: api/SysPict
        [HttpGet]
        public async Task<ActionResult<PaginationList<SysPict>>> GetSysPicts([FromQuery]PaginationParams paginationParams)
        {
            return await _context.SysPicts.GetPagedAsync(paginationParams);
        }

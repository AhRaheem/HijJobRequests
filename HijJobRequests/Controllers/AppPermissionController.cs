...
namespace HijJobRequests.Controllers
{
    ...
    public class AppPermissionController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<PaginationList<AppPermission>>> GetAppPermissions([FromQuery]PaginationParams paginationParams)
        {
            return await _context.AppPermissions.GetPagedAsync(paginationParams);
        }

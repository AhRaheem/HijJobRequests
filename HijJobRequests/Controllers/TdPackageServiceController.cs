...
namespace HijJobRequests.Controllers
{
    ...
    public class TdPackageServiceController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<PaginationList<TdPackageService>>> GetTdPackageServices([FromQuery]PaginationParams paginationParams)
        {
            return await _context.TdPackageServices.GetPagedAsync(paginationParams);
        }

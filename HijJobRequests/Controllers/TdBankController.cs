...
namespace HijJobRequests.Controllers
{
    ...
    public class TdBankController : ControllerBase
    {
        ...
        // GET: api/TdBank
        [HttpGet]
        public async Task<ActionResult<PaginationList<TdBank>>> GetTdBanks([FromQuery]PaginationParams paginationParams)
        {
            return await _context.TdBanks.GetPagedAsync(paginationParams);
        }

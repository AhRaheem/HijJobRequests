...
namespace HijJobRequests.Controllers
{
    ...
    public class TdOrderStatusController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<PaginationList<TdOrderStatus>>> GetTdOrderStatuss([FromQuery]PaginationParams paginationParams)
        {
            return await _context.TdOrderStatuses.GetPagedAsync(paginationParams);
        }

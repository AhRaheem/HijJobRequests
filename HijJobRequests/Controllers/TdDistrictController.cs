...
namespace HijJobRequests.Controllers
{
    ...
    public class TdDistrictController : ControllerBase
    {
        ...
        // GET: api/TdDistrict
        [HttpGet]
        public async Task<ActionResult<PaginationList<TdDistrict>>> GetTdDistricts([FromQuery]PaginationParams paginationParams)
        {
            return await _context.TdDistricts.GetPagedAsync(paginationParams);
        }
